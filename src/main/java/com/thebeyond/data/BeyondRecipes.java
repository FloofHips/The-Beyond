...
public class BeyondRecipes extends RecipeProvider {
    ...
    protected void buildRecipes(RecipeOutput recipeOutput) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, BeyondItems.MAGNET.get(), 1).define('M', BeyondItems.FERROJELLY).define('P', BeyondItems.FERROPETAL).pattern("M M").pattern("P P").pattern("PPP").unlockedBy(getHasName(BeyondItems.FERROPETAL), has(BeyondItems.FERROPETAL)).unlockedBy(getHasName(BeyondItems.FERROJELLY), has(BeyondItems.FERROJELLY)).save(recipeOutput);
