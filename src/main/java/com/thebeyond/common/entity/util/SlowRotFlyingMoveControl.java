...
public class SlowRotFlyingMoveControl extends FlyingMoveControl {
    private final int maxTurn;
    private final boolean hoversInPlace;

    public SlowRotFlyingMoveControl(Mob mob, int maxTurn, boolean hoversInPlace) {
    ...
    public void tick() {
        if (this.operation == Operation.MOVE_TO) {
            ...
            this.mob.setYRot(this.rotlerp(this.mob.getYRot(), f, (float)this.maxTurn));
            float f1;
