...
public class PerkaStalkerEntity extends LivingEntity implements OwnableEntity {
    private static final EntityDataAccessor<Integer> GENERATION = SynchedEntityData.defineId(PerkaStalkerEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Direction> FACING = SynchedEntityData.defineId(PerkaStalkerEntity.class, EntityDataSerializers.DIRECTION);
    private static final EntityDataAccessor<Boolean> VIOLENT = SynchedEntityData.defineId(PerkaStalkerEntity.class, EntityDataSerializers.BOOLEAN);
    protected static final EntityDataAccessor<Optional<UUID>> OWNER = SynchedEntityData.defineId(PerkaStalkerEntity.class, EntityDataSerializers.OPTIONAL_UUID);
    ...
    public PerkaStalkerEntity(EntityType<? extends LivingEntity> entityType, Level level) {
    ...
    private boolean isSpaceOccupied(BlockPos pos, Direction d) {
        ...
        if (!level().getEntitiesOfClass(PerkaStalkerEntity.class, new AABB(tailPos)).isEmpty()) return false;
        if (!level().getEntitiesOfClass(PerkaStalkerEntity.class, new AABB(headPos)).isEmpty()) return false;
