...
public class BrubbleModel <T extends BrubbleEntity> extends EntityModel<BrubbleEntity> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition fly = partdefinition.addOrReplaceChild("fly", CubeListBuilder.create().texOffs(0, 0).addBox(-7.5F, -7.5F, -7.5F, 15.0F, 15.0F, 15.0F, new CubeDeformation(0.0F))
                .texOffs(0, 30).addBox(-6.5F, -6.5F, -6.5F, 13.0F, 13.0F, 13.0F, new CubeDeformation(0.0F))
                .texOffs(45, 0).addBox(-10.5F, -10.5F, 0.0F, 8.0F, 8.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(45, 0).mirror().addBox(2.5F, -10.5F, 0.0F, 8.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(45, 30).mirror().addBox(2.5F, 3.5F, 0.0F, 8.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(45, 30).addBox(-11.5F, 3.5F, 0.0F, 8.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 16.5F, 0.0F));
