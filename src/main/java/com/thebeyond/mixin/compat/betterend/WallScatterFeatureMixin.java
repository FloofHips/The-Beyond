...
/** Same heightmap-collapse fix as {@link FullHeightScatterFeatureMixin}, applied to {@code WallScatterFeature.place}. */
@Pseudo
@Mixin(targets = "org.betterx.betterend.world.features.WallScatterFeature", remap = false)
public abstract class WallScatterFeatureMixin {
    @WrapOperation(
        method = "place",
        at = @At(
            value = "INVOKE",
